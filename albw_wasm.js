...
export class Cartridge {
    ...
    * @param {number} seed
    */
    constructor(jsettings, seed) {
        _assertNum(seed);
        const ret = wasm.cartridge_new(addHeapObject(jsettings), seed);
        return Cartridge.__wrap(ret);
    }
    /**
    * @returns {any}
    */
    get_trash_item_names() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.cartridge_get_trash_item_names(this.ptr);
    ...
    */
    get_progression_item_names() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.cartridge_get_progression_item_names(this.ptr);
        return takeObject(ret);
    }
    /**
    ...
    * @returns {any}
    */
    get_available_checks(obtained_items_js) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.cartridge_get_available_checks(this.ptr, addHeapObject(obtained_items_js));
        return takeObject(ret);
    }
    /**
    * @returns {any}
    */
    get_plando() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.cartridge_get_plando(this.ptr);
        return takeObject(ret);
    }
}
...
function getImports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_111594b7356a331b = function() { return logError(function (arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('albw_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
